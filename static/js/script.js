...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
    ...
    messageDiv.innerHTML = "<h1 style='color:" + finalMessage['color'] + "; font-size: 60px; padding: 30ps; '>" + finalMessage['message'] + "</h1>"
...
function blackjackDeal() {
    if (blackjackGame['turnsOver'] === true) {
        ...
        document.querySelector("#blackjack-result").textContent = 'Let` play again';
...
function computeWinner() {
    ...
    if(YOU['score'] <= 21) {
        //condition : higher score than dealer or wehen bust but you`re 21 or under 
